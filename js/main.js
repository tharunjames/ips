...
$(document).ready(function($) {
    ...
    $('#flickr').jflickrfeed({
		...
		qstrings: {
			id: '151779874@N04'//Change this to any Flickr Set ID as you prefer.
		},
    ...
    if(v.length == 0)
	{
		$('.result').html("<div class='alert alert-danger'>Captcha Check cannot be left Unattended</div>");
	} else{
		
	    $.get(url, datos, function(resultado) {  
	    	$('.result').html(resultado);  
			if(resultado.includes("alert-success")){
				$(':input','.form-contact')
